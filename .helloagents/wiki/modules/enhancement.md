...
- 新增增强器：InstanceTrackEnhancer（vmtool track，构造器返回时上报实例；避免 this(...) 构造链重复上报）。
...
- 202602042257_vmtool_instance_diagnostics (history/2026-02/202602042257_vmtool_instance_diagnostics/) - InstanceTrackEnhancer（构造器实例追踪）
