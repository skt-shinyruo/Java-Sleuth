...
public class TraceCommand implements StreamCommand, SpecBackedCommand {
    ...
    public static CommandSpec spec() {
        return CommandSpec.builder("trace")
            ...
            .hiddenOption(OptionSpec.string("sample").alias("--sample").missingValueAsEmptyString().build())
            .hiddenOption(OptionSpec.string("sample-rate").alias("--sample-rate").missingValueAsEmptyString().build())
